<%-- 
    Document   : home
    Created on : Nov 5, 2018, 9:39:07 AM
    Author     : NOTEBOOK
--%>
...
<style>
	...
	.nav li{
		border-bottom: 2px solid #473f3f;
		border-radius: 5px;
	}
	.daftar h3{
                margin-top: 50px;
...
<div class="container">
	...
	<ul class="nav nav-pills nav-stacked" style="">
            <li><a href="#">Home</a></li>
            <li><a href="/Modul_kel26/login.jsp">Logout</a></li>
	</ul>
	</div>
	<div  class="col-md-9 daftar">
            <form action="/Modul_kel26/StudentServlet" method="POST">
